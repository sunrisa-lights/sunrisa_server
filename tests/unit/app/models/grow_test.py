...
def test_create_grow():
    ...
    grow = Grow(1, 2, start, end, True, True, 5)
...
def test_to_json():
    ...
    grow_to_json = Grow(1, 2, start5, end, True, True, 5)
...
def test__str__():
    ...
    grow = Grow(1, 2, start6, end, True, True, 5)
    grow2 = Grow(1, 2, start6, end, True, True, 5)
...
def test__hash__():
    ...
    grow3 = Grow(2, 3, start, end2, False, False, 4)
    grow4 = Grow(2, 3, start, end2, False, False, 4)
...
def test__hash__fail():
    ...
    end2 = start + timedelta(0, 2)
    grow3 = Grow(2, 3, start, end2, True, False, 4)
    grow4 = Grow(2, 3, start2, end2, True, True, 4)
...
def test__eq__():
    ...
    grow2 = Grow(1, 2, start, end, True, True, 3)
    grow3 = Grow(1, 2, start, end, True, True, 3)
...
def test__eq__fail():
    ...
    grow3 = Grow(1, 2, start, end, True, False, 6)
    grow4 = Grow(1, 2, start2, end, False, True, 6)
