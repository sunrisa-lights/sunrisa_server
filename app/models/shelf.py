...
class Shelf():
    ...
    def __str__(self):
        return json.dumps({'shelf_id': self.shelf_id, 'rack_id': self.rack_id, 'recipe_id': self.recipe_id})
    ...
    def __eq__(self, other):
        ...
        return self.shelf_id == other.shelf_id and self.rack_id == other.rack_id and self.recipe_id == other.recipe_id
