...
class Rack():
    ...
    def __init__(self, rack_id: int, room_id: int, voltage: int, is_on: bool, is_connected: bool):
    ...
    def __str__(self):
        return json.dumps({'rack_id': self.rack_id, 'room_id': self.room_id, 'voltage': self.voltage, 'is_on': self.is_on, 'is_connected': self.is_connected})
    ...
    def __eq__(self, other):
        ...
        return self.rack_id == other.rack_id and self.room_id == other.room_id and self.voltage == other.voltage and self.is_on == other.is_on and self.is_connected == other.is_connected
